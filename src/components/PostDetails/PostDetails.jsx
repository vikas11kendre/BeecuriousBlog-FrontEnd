      ...
      <Grid item xs={12} sx={{ mt: "40px" }}>
        ...
        >
          <Paper>
            <Box
              ...
              alt={post.name}
              sx={{ display: "flex", maxWidth: "100%", maxHeight: "450px" }}
            />
          </Paper>
        </Box>
        <Box
        ...
        >
          <Typography
            align="center"
            variant="h4"
            sx={{ fontWeight: "600", color: "#030303" }}
          >
            {post.title}
          </Typography>
        </Box>
        ...
        >
          <Typography
            sx={{ mr: "20px", fontWeight: "600", color: "#46364a" }}
            align="center"
            variant="body1"
          >
            Tags :
        ...
        >
          ...
          >
            ...
            <Typography
              variant="body1"
              sx={{ ml: "20px", fontWeight: "bold", color: "#6b7688" }}
            >
              {post.name}
            </Typography>
            <ThumbUpAltIcon
              sx={{ ml: "20px", color: "#505BF7" }}
              fontSize="small"
            />
            <Typography variant="body1" sx={{ ml: "5px" }}>
              {post.likes.length}
            </Typography>
            <Typography variant="body1" sx={{ ml: "20px", color: "#46364a" }}>
